...
xauusd_rates2 = pd.read_csv(r'C:\Users\kkeng\Desktop\backtest\ADX+PSar\1-1-2020 to 30-6-2020\profit_ADX+PSar_DailyProfit+NotOpenOrder.csv',encoding="utf-16",sep='\t')
xauusd_rates2 = xauusd_rates2['Profit']
print(xauusd_rates2[0])
getClose = xauusd_rates2.values.tolist()
print(getClose)
